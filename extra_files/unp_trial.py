            ...
            for src in ['unp']:
                ...
                if src in ['unp']:
                    ...
                    if(l1jet_br['rawEt'][iEvent][l1jet_idx] or l1jet_br['puEt'][iEvent][l1jet_idx] <=0):
                        ...
                        print("l1jet_br['rawEt'][iEvent][l1jet_idx] ", l1jet_br['rawEt'][iEvent][l1jet_idx] )
                        print("l1jet_br['puEt'][iEvent][l1jet_idx] ", l1jet_br['puEt'][iEvent][l1jet_idx])
