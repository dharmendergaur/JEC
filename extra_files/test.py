...
def process_event(iEvent, Jet_br, Muon_br, Ele_br, Unp_br, Emu_br, Vtx_br, Evt_br, eTT_br, uTT_br, eTC_br):
    l1JetRef_br = None
    nRefJets    = 0
    et_RefJets  = None
    eta_RefJets = None
    ...
    if sFInEventsToRun: # and runMode in ['trbshtPhiRingPUS']:
        ...
        # if sRunLSEvent not in eventsToRun_list:
        #     continue
    ...
    if not isMC and len(HLT_Triggers_Required) > 0:
        ...
        # if not passingTrigThshs: return
...
#  parallel processing
    with concurrent.futures.ThreadPoolExecutor() as executor:
        futures = [executor.submit(process_event, iEvent, Jet_br, Muon_br, Ele_br, Unp_br, Emu_br, Vtx_br, Evt_br, eTT_br, uTT_br,eTC_br) for iEvent in range(Ntot)]
